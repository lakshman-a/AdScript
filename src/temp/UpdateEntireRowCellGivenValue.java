...
public class UpdateEntireRowCellGivenValue {
	...
	public static void main(String[] args) throws IOException {
		...
		//String oldValue="10.6";
		//String updValue="10.60";
		//String oldValue="3";
		//String updValue="3.00";
		String oldValue="true";
		String updValue="1";
		//String oldValue="50";
		//String updValue="50.00";
			...
			if(index >=0 ){	
				...
				int colNum = ws.getRow(0).getLastCellNum();
					...
					for (int j = 0 ; j < colNum ; j++) {
						...
						if(cellValue.trim().equalsIgnoreCase(oldValue)){
							//System.out.println("Old value found...");
							System.out.println("The Cell Value is '" + cellValue+"'");
							//System.out.println("Elment should be updated as NULL");
							cell.setCellValue(updValue);
