 ...
 * To Update Cell Type of the complete sheet except the header row where input is the WorkSheet Name
...
public class UpdateEntireSheetType {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int filePointer = 0; filePointer < excelFiles.length; filePointer++) {   
			...
			if(index >=0 ){	
				...
				//To Loop through all the Rows use below line
